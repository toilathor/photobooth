...
class PrintService {
  ...
  static Future<bool> printImage(Uint8List imageBytes, {String name = 'photobooth_photo'}) async {
    try {
      ...
      final result = await Printing.layoutPdf(
        onLayout: (PdfPageFormat format) async {
          ...
          printDoc.addPage(
            pw.Page(
              pageFormat: format,
              margin: const pw.EdgeInsets.all(0), // Không lề để ảnh hiển thị tối đa kích thước giấy
